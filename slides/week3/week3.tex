...
Eviews has a built-in method, based on \emph{\color{red}non-linear least-squares}.
...
\item \er{Estimation}: Like pure MA models, ARMA models cannot be estimated by OLS because the past values of $U_{t}$ are unobserved. Eviews has built-in methods however.
