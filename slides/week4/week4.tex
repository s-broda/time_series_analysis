\input{../preamble.tex}
\institute{{\Large Unit Roots; Regressions between Time Series}}
\begin{document}
\frame{\titlepage}
\input{../weeks.tex}
...
decrease test power.
\item Often the choice is made based on \er{model selection criteria} (AIC, BIC). EViews has a built-in option to
